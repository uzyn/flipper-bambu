/*
 * Vendored verbatim from flipperzero-firmware (GPL-3.0), source:
 *   applications/main/nfc/plugins/supported_cards/nfc_supported_card_plugin.h
 *   commit c9ab2b6827fc4d646e98ad0fc15a264240b58986 (the pinned submodule revision)
 *
 * This header is not shipped in the published Flipper SDK headers, so the ufbt
 * build path has no way to reach it. The fbt path does not use this copy: `make
